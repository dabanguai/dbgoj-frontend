  ...
  <div id="addQuestionView">
    ...
    <a-form :model="form">
      ...
      >
        ...
        >
          <a-space direction="vertical" style="min-width: 480px">
            ...
            <a-form-item
              :field="`form.judgeCase[${index}].outCase`"
              :label="`输出用例-${index}`"
              :key="index"
            >
              <a-input
      ...
      <a-form-item style="margin-top: 16px">
        <a-button type="primary" style="min-width: 160px" @click="doSubmit"
          >提交
        </a-button>
      </a-form-item>
    </a-form>
...
// todo 做修改数据功能时，通过后端对修改人员做权限校验，若为创建者自己或管理员则判定为可修改，跳转至修改页面，同时返回的时非脱敏数据
/**
 * 根据题目id获取老的数据
 */
